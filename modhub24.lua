...
local FakeLithub = PlayerScripts:CreateButton({
   Name = "FREE LITHUB (TOTALY REAL 100% SIGMA)",
   Callback = function()
local player = game.Players.LocalPlayer

local whySoSerious = Instance.new("Sound",workspace)
local nevergonnagiveyouup = Instance.new("Sound",workspace)
local ahh = Instance.new("DistortionSoundEffect",whySoSerious)
local scari = Instance.new("ColorCorrectionEffect",game.Lighting)
local hint = Instance.new("Hint",workspace)
whySoSerious.Name = "use lit hub next time lil bro"
whySoSerious.PlaybackSpeed = 0.5
whySoSerious.Volume = 0.2
whySoSerious.Looped = true
whySoSerious.SoundId = "rbxassetid://71657146025636"

nevergonnagiveyouup.SoundId = "rbxassetid://7255999109"
nevergonnagiveyouup.Volume = 0.5

scari.Name = "fromthescreentotheringtothepentothekingwhereismycrownthatsmyblingalwaysdramawheniring"
scari.Brightness = -3
scari.Contrast = 432432
scari.Saturation = -3
scari.TintColor = Color3.fromRGB(255, 0, 4)

hint.Name = ""
hint.Text = "you thought lil bro 😭🙏"
...
local Speedrun = Misc:CreateButton({
   ...
   Content = "This are things idk too.",
   Duration = 6.5,
